...
from event_processors.public.message import MessageEventProcessor
from event_processors.public.member import MemberEventProcessor
...
class Processor:
    ...
    async def handle(self) -> None:
        ...
        if self.internal_event.event_type == EventType.message:
            ...
            logger.info('[PROCESSOR] routing to Public MessageEventProcessor ...')
            ...
            logger.info('[PROCESSOR] routing to Public MemberEventProcessor ...')
