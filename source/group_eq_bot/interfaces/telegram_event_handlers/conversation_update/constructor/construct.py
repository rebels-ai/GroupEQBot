...
class Constructor:
    ...
    entrypoints: CallbackQueryHandler = field(init=False)  # not initialising here, instead traversing the questions
    ...
    def __post_init__(self):
        ...
        for question in preprocessed_questions:
            if question['question_index'] == 1:  # if StartCommand (1st question) question
                _entrypoints = StartButtonBuilder(question=question).handler
